...
if (process.env.VCAP_SERVICES) {
  ...
  for (var index in iotService) {
    if (iotService[index].name === "iot-demo") {
...
app.get("/iotServiceLink", function(req, res) {
  ...
  var org_req = https
    .request(options, function(org_res) {
      var str = "";
      ...
      org_res.on("end", function() {
        try {
          ...
          var url =
            "https://console.ng.bluemix.net/#/resources/serviceGuid=" +
            org.bluemix.serviceInstanceGuid +
            "&orgGuid=" +
            org.bluemix.organizationGuid +
            "&spaceGuid=" +
            org.bluemix.spaceGuid;
          res.json({ url: url });
        } catch (e) {
...
app.post("/registerDevice", function(req, res) {
  ...
  var type_req = https
    .request(options, function(type_res) {
      var str = "";
      ...
      type_res.on("end", function() {
        ...
        var dev_req = https
          .request(dev_options, function(dev_res) {
            var str = "";
